...
<img src="/posts/Valorant/razeJett.jpeg" style="display: block; margin-right: auto; width: 70%; height: 70%;"/>
...
## What are we going to do for users?
...
Furthermore, users will have access to attack and defense win rates for each map, which offer insights into the map's underlying design philosophy. A map skewed towards attack could suggest a fast-paced, aggressive combat, while a defense-oriented map might encourage meticulous attacking plans and teamwork. Understanding this balance provides players with a deeper knowledge of map dynamics.

![mapWinrate](/posts/Valorant/mapWinrate.jpeg)

Lastly, we will display the top three compositions favored by pro teams in tournaments for each map. This feature opens a window into investigating team strategies for new players. By adopting these compositions, the players can enjoy the pros' tactics, implementing a more competitive approach alongside friends. By mirroring the pros' choice, they can easliy amplify their learning curve.

<img src="/posts/Valorant/tournament.jpeg" style="display: block; margin-right: auto; width: 86%; height: 86%;"/>

With these features, our website doesn't just offer information; it offers a foundation and environment upon which players can build their in-game strategies intuitively. And as they grow more familiar with these agent-map dynamics and tournament level team compositions, they naturally begin to experiment, adapt, and eventually master the tactical depth that Valorant offers.
